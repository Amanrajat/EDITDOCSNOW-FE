...
export function SkeletonViewer() {
  return (
    <div className="flex h-full w-full items-center justify-center bg-slate-100 p-8 dark:bg-white/5">
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      {Array.from({ length: count }).map((_, index) => (
        <div key={index} className="flex flex-col gap-2 rounded-xl border border-border p-3 dark:border-dark-border">
